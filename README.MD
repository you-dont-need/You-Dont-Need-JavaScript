#these css files contain various effects and animations without JS.
...
2. [Carousel](#Carousel)
3. [Counter of checked check-boxes](#Counter)
4. [Flip on click](#Flip)
5. [Floating label on Textfield](#Floating)
6. [Font-Face (Latin)](#Font)
7. [Info on hover/ Popover](#Info)
8. [Image Gallery](#Image)
9. [Menu](#Menu)
10. [Mobile menu off canvas](#Mobile)
11. [Burger menu](#BurgerMenu)
12. [Fancy menu](#FancyMenu)
13. [Modal/Popup](#Modal)
14. [Mouse tracking](#Mouse)
15. [Parallax scrolling](#Parallax)
16. [Tabs](#Tabs)
17. [Todo List](#Todo)
18. [Tooltips](#Tooltips)
19. [Treeview](#Treeview)
20. [Twitter Heart Animation](#Twitter)
21. [Dynamic Image Colorizing](#ImageColorizing)
22. [Ripple Effect](#RippleEffect)
23. [Responsive Counter Showing # of Items That Didn't Fit Screen](#ResponsiveItemShowcase)
